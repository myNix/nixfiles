...
, termite, ipython, gnome_keyring, redshift, alot
...
let
  ...
  self= brightness: writeText "i3-config-${brightness}"
    ''
      ...
      exec --no-startup-id ${redshift}/bin/redshift -l 46.866667:2.333333 -t 5700:3600
...
in {
  ...
  packages = {
    inherit i3 i3status xrandr feh py3status rofi-menugen termite ipython
      gnome_keyring redshift alot rofi rofi-pass
